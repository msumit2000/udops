...
class UserManagementHandler:
    ...
    def update_team(self, permanent_access_token, tenant_id, admin_user_name, s3_base_path, s3_destination_path, existing_teamname,new_teamname):
        try:
            user = UserManagementManager()
            return user.update_team(permanent_access_token, tenant_id, admin_user_name, s3_base_path, s3_destination_path, existing_teamname,new_teamname)
        except Exception as e:
            raise e
    ...
    def add_team(self, permanent_access_token, tenant_id, admin_user_name, s3_base_path, s3_destination_path, teamname):
        try:
            user = UserManagementManager()
            return user.add_team(permanent_access_token, tenant_id, admin_user_name, s3_base_path, s3_destination_path, teamname)
        except Exception as e:
            raise e
